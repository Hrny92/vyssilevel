...
const zdroje: { icon: IconDefinition; label: string; sublabel: string }[] = [
  ...
  { icon: faDatabase,    label: "Pool aktivních leadů",     sublabel: "z realitních poptávek"                      },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-white/40 text-sm max-w-md mx-auto">
            Více zdrojů znamená více příležitostí pro vás. Klienti přicházejí z více směrů najednou.
          </p>
        </div>
